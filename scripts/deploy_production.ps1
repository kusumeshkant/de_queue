...
# production bundle for dq_app (dq.dqstore.in).
#
...
# the correct new bundle immediately - but the custom domain (dq.dqstore.in)
...
param(
    [string]$ProjectName = "dq-app",
    [string]$Domain      = "dq.dqstore.in",
