...
/// Tracks release-level health signals: startup duration, session identity,
/// and version tagging for Crashlytics grouping.
///
/// Must be registered as a permanent GetX service immediately after
/// [AnalyticsService] and [CrashlyticsService] in main().
class ReleaseHealthService extends GetxService {
  ...
  void _reportStartup(int startupMs) {
    ...
    // Flag slow startups (> 5 seconds from service init to ready)
    if (startupMs > 5000) {
