...
abstract class AppColorsLight {
  ...
  // Overlay surfaces (sheets, nav bar, dialogs)
  static const Color sheetSurface = Color(0xF2FFFFFF); // white 95%
  static const Color floatSurface = Color(0xF7FFFFFF); // white 97%
  static const Color navBarSurface = Color(0xCCFFFFFF); // white 80%
  static const Color dialogSurface = Color(0xFFFFFFFF); // white opaque
...
abstract class AppColorsDark {
  ...
  // Overlay surfaces (sheets, nav bar, dialogs)
  static const Color sheetSurface = Color(0xD1000000); // black 82%
  static const Color floatSurface = Color(0xD1000000); // black 82%
  static const Color navBarSurface = Color(0x8C000000); // black 55%
  static const Color dialogSurface = Color(0xFF1A2B3C); // dark navy opaque
